...
# # Or where clause single obj
# print("Where colour = red or volume > 300 ml")
# sub_where_colour = WhereClause(where_tp='feature_enum', obj_tp='cup', enum_feature='colour', enum_param='red')

# sub_where_volume = WhereClause(where_tp='feature_scalar', obj_tp='cup', scalar_feature='volume', scalar_param='0.300', scalar_comparator='Gt')

# new_where = WhereClause(where_tp='or', obj_tp='cup', sub_where_clause=[sub_where_colour, sub_where_volume])
...
# # Min where clause single obj
# print("Where min(volume)")
# new_where = WhereClause(where_tp='min', obj_tp='cup', scalar_feature='volume')
# print(new_where.pretty_str())
